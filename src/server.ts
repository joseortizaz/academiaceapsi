...
const SECURITY_HEADERS: Record<string, string> = {
  "Content-Security-Policy": [
    ...
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://source.zoom.us https://*.zoom.us",
    "script-src-elem 'self' 'unsafe-inline' https://source.zoom.us https://*.zoom.us",
    "style-src 'self' 'unsafe-inline' https://source.zoom.us https://fonts.googleapis.com",
    "style-src-elem 'self' 'unsafe-inline' https://source.zoom.us https://fonts.googleapis.com",
    "font-src 'self' data: https://fonts.gstatic.com https://source.zoom.us",
    "img-src 'self' data: blob: https:",
    "media-src 'self' data: blob: https: https://*.zoom.us",
    "connect-src 'self' data: blob: https: wss: https://*.zoom.us wss://*.zoom.us https://source.zoom.us",
